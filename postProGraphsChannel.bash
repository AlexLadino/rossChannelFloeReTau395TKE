...
# CAMPOS ESCALARES
filesToPlot="100.2 200.20 300.2 400.2 600.2 800.2 1000.2 1200.2 1400.2 1600.2 2000.2 2400.2 2800.2 3200.2 3600.2 4000.2 4400.2 4800.2 5200.2 5600.2"
variables=('p' 'pMean')
espesor=('2' '1')
numFilesToPlot=2
numComponents=1
...
#      echo este es yRange yRange
      ...
      for k in $filesToPlot
      do
            
            reconstructPar -time \'$k\'\
            postChannel -time \'$k\'\
            
            
            # vaya a la carpeta graphs
            
            # cree la carpeta del termino turbulento            
